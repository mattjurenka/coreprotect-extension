<script>
  ...
  import { calculate_dollar_value, format_bignum_from_hex, format_decimal } from "../../../utils";
  ...
  <div class="flex mb-2">
    <div class="flex flex-col justify-center">
      <p class="text-base font-jetbrains underline decoration-2 underline-offset-2 font-bold">
        ERC20 TransferFrom - <Etherscanlink contract_hex={contract}/>
      </p>
    </div>
  ...
  {#if help_expanded}
    <div class="my-1 p-2 bg-lightgrey">
      <p class="font-jetbrains text-paragraph">
        ...
        from <Etherscanlink contract_hex={sender} /> to <Etherscanlink contract_hex={recipient} />.
        At current Uniswap price, this transfer represents a value of ${format_decimal(dollars_transferred)} in USD.
      </p>
    </div>
  {/if}
  <p class="text-base font-jetbrains mb-1">From: <Etherscanlink contract_hex={sender} /></p>
  <p class="text-base font-jetbrains mb-1">To: <Etherscanlink contract_hex={recipient} /></p>
